...
;; ## added by OPAM user-setup for emacs / ocp-indent ## b87f043c502824176e73d65f024c501d ## you can edit, but keep this line
;; Load ocp-indent from its original switch when not found in current switch
(when (not (assoc "ocp-indent" opam-tools-installed))
  (autoload 'ocp-setup-indent "/home/yun/.opam/system/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Tuareg mode")
  (autoload 'ocp-indent-caml-mode-setup "/home/yun/.opam/system/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Caml mode")
  (add-hook 'tuareg-mode-hook 'ocp-setup-indent t)
  (add-hook 'caml-mode-hook 'ocp-indent-caml-mode-setup  t)
  (setq ocp-indent-path "/home/yun/.opam/system/bin/ocp-indent"))
;; ## end of OPAM user-setup addition for emacs / ocp-indent ## keep this line
;; ## added by OPAM user-setup for emacs / tuareg ## 77c0c28ababfc52a94a79a84fa28a359 ## you can edit, but keep this line
...
(defun opam-tuareg-autoload (fct file doc args)
  (let ((load-path (cons "/home/yun/.opam/system/share/emacs/site-lisp" load-path)))
    (load file))
  (apply fct args))
